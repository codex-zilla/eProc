...
const TeamManagement = ({ projectId, projectOwnerId }: TeamManagementProps) => {
    ...
    return (
        <Card className="flex flex-col shadow-none border-slate-200/50">
            ...
            <CardContent className="p-0 px-2 sm:px-4 flex-1">
                            ...
                            {team.length > 0 && (
                                <div className="space-y-3 py-1">
                                    {sortedTeam.map(member => (
                                        <div key={member.id} className="flex items-start gap-3 relative group rounded-lg p-2 hover:bg-slate-50/50 transition-colors">
