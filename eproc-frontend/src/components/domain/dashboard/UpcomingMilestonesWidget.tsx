            ...
            <Card className="border-slate-200 shadow-sm">
                <CardHeader className="p-3 border-b border-slate-100 bg-slate-50/50">
                    <CardTitle className="text-base font-bold text-[#2a3455] flex items-center">
                        <CalendarClock className="h-4 w-4 mr-2 text-[#2a3455]" />
                        Upcoming Milestones
                    </CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                    <div className="p-6">
                        <EmptyState
                            ...
                            description="Milestones will appear here once added to projects."
                            className="py-2"
                        />
                    </div>
                </CardContent>
        ...
        <Card className="border-slate-200 shadow-sm flex flex-col h-full">
            ...
            <CardContent className="p-0 flex-1 overflow-y-auto">
                <ul className="divide-y divide-slate-100">
                    {milestones.map((m) => (
                        <li key={m.id} className="px-4 py-2 hover:bg-slate-50 transition-colors">
