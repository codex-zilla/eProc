...
export function SummaryStatGrid({ stats, className }: SummaryStatGridProps) {
    return (
        <div className={cn("flex overflow-x-auto sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 pb-1 sm:pb-2 scrollbar-hide snap-x snap-mandatory", className)}>
