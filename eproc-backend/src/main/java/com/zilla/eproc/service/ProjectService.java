...
public class ProjectService {
        ...
        public ProjectDTO createProject(ProjectDTO dto, String ownerEmail) {
                ...
                Project project = Project.builder()
                                ...
                                // Core Identification
                                .code(dto.getCode())
                                .industry(dto.getIndustry() != null
                                                ? com.zilla.eproc.model.Industry.valueOf(dto.getIndustry())
                                                : null)
                                .projectType(
                                                dto.getProjectType() != null
                                                                ? com.zilla.eproc.model.ProjectType
                                                                                .valueOf(dto.getProjectType())
                                                                : null)
                                // Owner Rep
                ...
                ProjectDTO.ProjectDTOBuilder builder = ProjectDTO.builder()
                                ...
                                .teamCount(
                                                project.getTeamAssignments() != null
                                                                ? (int) project.getTeamAssignments().stream()
                                                                                .filter(pa -> Boolean.TRUE.equals(
                                                                                                pa.getIsActive()))
                                                                                .count()
                                                                : 0)
